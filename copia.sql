...
CREATE TABLE `purchases` (
  ...
  CONSTRAINT `purchases_ibfk_1` FOREIGN KEY (`provider_id`) REFERENCES `providers` (`provider_id`)
...
INSERT INTO `purchases` VALUES (1,1,'2022-02-01','SB-01'),(2,2,'2022-02-02','S-01'),(3,2,'2022-03-01','S-01');
...
CREATE TABLE `sales` (
  ...
  CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`stock_ref`) REFERENCES `stock` (`stock_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sales` VALUES (1,'2022-02-05',4,2),(2,'2022-02-08',1,1),(3,'2022-02-09',3,3),(4,'2022-02-09',4,2),(5,'2022-02-15',2,5),(6,'2022-02-18',5,2),(7,'2022-02-25',4,1),(8,'2022-03-02',2,5),(9,'2022-03-10',6,7),(10,'2022-02-10',3,2);
...
INSERT INTO `stock` VALUES (1,1,3,10000,13000,9,1),(2,1,8,3000,5000,10,10),(3,1,6,7000,10000,10,5),(4,2,1,15000,20000,0,5),(5,2,2,14000,19000,8,2),(6,3,1,16000,21000,0,4);
...
-- Dump completed on 2022-07-20 20:58:09
